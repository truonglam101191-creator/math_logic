                ...
                children: [
                  AnimatedScaleButton(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        spacing: 5,
                        children: [
                          Icon(Icons.offline_bolt, color: Colors.blue.shade600),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFFDFF7FA).withOpacity(0.3),
                          blurRadius: 8,
                          spreadRadius: 1,
                        ),
                      ],
                                      ...
                                      serviceLocator
                                          ...
                                          .showInterstitialAd(
                                            callback: (isSucess) async {
                                              final coin = await serviceLocator
                                                  .get<DataBaseFuntion>()
                                                  .getStar();
                    ...
                    children: [
                      ...
                      _SmallCard(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            createRouter(
                              TopicListPage(enumTopicMath: EnumTopicMath.think),
                            ),
                          );
                        },
                      ),
                      ...
                      _SmallCard(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(context, createRouter(ListGamePage()));
                        },
                      ),
                    ],
                  ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 44,
              decoration: BoxDecoration(
                color: btnColor.withOpacity(0.95),
                borderRadius: BorderRadius.circular(12),
                boxShadow: [
                  BoxShadow(
