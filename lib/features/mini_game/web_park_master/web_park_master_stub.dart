...
class WebparkMasterPalStub extends StatefulWidget {
  const WebparkMasterPalStub({super.key, this.onGameEnd});

  final void Function(int score)? onGameEnd;

  @override
  State<WebparkMasterPalStub> createState() => _WebPackPalStubState();
}

class _WebPackPalStubState extends State<WebparkMasterPalStub> {
    ...
    try {
      ...
      try {
        String html = await rootBundle.loadString(
          'assets/park_master/park_master.html',
        );

        final config = await rootBundle.loadString(
          'assets/park_master/config.json',
        );
        ...
        final assets = await rootBundle.loadString(
          'assets/park_master/assetMap.json',
        );
