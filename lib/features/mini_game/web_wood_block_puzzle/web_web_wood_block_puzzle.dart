...
class WebWebWoodBlockPuzzle extends StatefulWidget {
  const WebWebWoodBlockPuzzle({super.key, this.onGameEnd});

  final void Function(int score)? onGameEnd;

  @override
  State<WebWebWoodBlockPuzzle> createState() => _WebPackPalStubState();
}

class _WebPackPalStubState extends State<WebWebWoodBlockPuzzle> {
    ...
    try {
      ...
      try {
        String html = await rootBundle.loadString(
          'assets/wood_block_puzzle/wood_block_puzzle.html',
        );

        final config = await rootBundle.loadString(
          'assets/wood_block_puzzle/config.json',
        );
        ...
        final assets = await rootBundle.loadString(
          'assets/wood_block_puzzle/assetMap.json',
        );
