...
class TermsOfConditionsPage extends StatelessWidget {
  TermsOfConditionsPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: HtmlWidget(
          contentHTML
              .replaceAll('{0}', Shared.instance.packageInfo.appName)
              .replaceAll('{1}', Configs.companyName)
              .replaceAll('{2}', Configs.emailSupport)
              .replaceAll('{3}', Configs.dateTimeUpdateApp),
          textStyle: Theme.of(
            context,
